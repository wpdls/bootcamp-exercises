class Race {
    constructor (name, velocity, color) {
        this.name = name;
    ...
    render () {
        ...
        this.element.className = 'snailgame';
    ...
    update () {
        ...
        this.element.style.marginLeft = `${this.velocity}rem`; 

        const shell = this.element.querySelector('.snail__shell');
        shell.style.fill= this.color;
      
        const nameSnail = this.element.querySelector('.snail-racer__name')
        nameSnail.textContent = this.name;
